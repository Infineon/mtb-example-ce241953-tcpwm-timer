...
This code example shows how to configure the timer function using timer, counter and pulse-width modulator (TCPWM) block, and describes its operation and initial settings.

[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce241953-tcpwm-timer)

[Provide feedback on this code example.](https://cypress.co1.qualtrics.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[mtb-example-ce241953-tcpwm-timer](https://github.com/Infineon/mtb-example-ce241953-tcpwm-timer)" application with the desired name "TcpwmTimer" configured for the *KIT_PSOC4-HVMS-128K_LITE* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSOC4-HVMS-128K_LITE --app-id mtb-example-ce241953-tcpwm-timer --user-app-name TcpwmTimer --target-dir "C:/mtb_projects"
   ```
...
3. After programming, the application starts automatically. For this code example, use an oscilloscope to monitor user LED port pin(0_3) to check the period timing and you can confirm it by observing the LED ON/OFF

   **Figure 1. Timer waveform**

   <img src="./images/timer_waveform.png" width="1024">
...
1. Initializes and enables TCPWM timer interrupt handler
2. Initializes and enable to TCPWM timer
3. Starts to TCPWM timer
4. LED toggles by timer interrupt handler
...
:------- | :------------    | :------------ 
TCPWM | TCPWM | To perform a TCPWM timer
GPIO | CYBSP_USER_LED6 (KIT_PSOC-HVPA-SPM1_LITE) <br> CYBSP_USER_LED7 (Other boards) | Shows timer interrupt period
...
Libraries on GitHub  | [retarget-io](https://github.com/Infineon/retarget-io) – Utility library to retarget STDIO messages to a UART port <br>  [mtb-pdl-cat2](https://github.com/Infineon/mtb-pdl-cat2) – PSOC&trade; 4 Peripheral Driver Library (PDL)
...
Document title: *CE241953* – *PSOC&trade; 4: TCPWM timer*
